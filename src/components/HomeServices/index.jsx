        ...
        <>
            <section id="homeServices">
                <div className="container">
                    ...
                    <div className="row">
                        <HomeLeftMenu number={3} y={y}/>
                        <div className="col-11 cen">
                            <div className="row row1">
                                {[
                                    {
                                        title: "SWEJI CAKE HOUSE",
                                        name: "AMİL HÜSEYİNOV",
                                    ...
                                    {
                                        title: "FRİPS FRUİT CHİPS",
                                        name: "AQİL MƏMMƏDZADƏ",
                                        img: "https://plus.unsplash.com/premium_photo-1683134080778-aaa686741d0a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fHBvcnRyYWl0fGVufDB8fDB8fHww"
                                    },
                                    {
                                        title: "MACİS CONSULTİNG",
                                        name: "XƏYALƏ SURXAYLI",
                                        img: "https://img.freepik.com/free-photo/portrait-young-woman-with-natural-make-up_23-2149084942.jpg"
                                    },
                                    {
                                        title: "KHANSA FINANCE",
                                        name: "NURU XƏLİLOV",
